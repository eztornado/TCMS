...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.reigreengroup.tcms'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Panel TornadoCMS: gestión de contenidos, eventos y tienda.'),

    /**
     * The Website of your application.
     */
    'website' => env('NATIVEPHP_APP_WEBSITE', 'https://reigreengroup.com'),
    ...
    'cleanup_env_keys' => [
        ...
        '*_SECRET',
        'BIFROST_*',
        // TCMS: nada de pagos ni correo real dentro del binario.
        'STRIPE_*',
        'MAIL_*',
        'DB_PASSWORD',
        'REDIS_PASSWORD',
    ...
    'cleanup_exclude_files' => [
        ...
        'node_modules',
        '*/tests',
        // TCMS: el monorepo vive alrededor del api; al binario solo le importa él.
        'front',
        'docs',
        'docker',
        '.github',
        '.env.native',
        // La BD sqlite de desarrollo local jamás viaja en el instalador.
     ...
     */
    'prebuild' => [
        // Panel React embebido: el binario lo sirve el propio Laravel (public/ui).
        'cd ../front && BUILD_TARGET=native npm run build',
    ],

    'postbuild' => [
        // Devuelve el .env de desarrollo tras empaquetar (ver native:prepare-env).
        '@php artisan native:prepare-env --restore',
    ],
